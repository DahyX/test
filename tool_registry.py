...
class ToolRegistry:
    def __init__(self, plugin_loader=None):
        ...
        self._native_tools = {
            ...
            "file_read": {"desc": "Read exact file contents (Claude Code tool)", "risk": "low", "confirm": False},
            "file_write": {"desc": "Write entirely new file contents (Claude Code tool)", "risk": "high", "confirm": True},
            "glob": {"desc": "Search codebase by path patterns (Claude Code tool)", "risk": "low", "confirm": False},
            "grep": {"desc": "Search codebase by regex content (Claude Code tool)", "risk": "low", "confirm": False},
            "str_replace": {"desc": "Replace exact string inside a file (Claude Code tool)", "risk": "medium", "confirm": True},
            "bash": {"desc": "Execute raw shell command in local environment (Claude Code tool)", "risk": "high", "confirm": True},
